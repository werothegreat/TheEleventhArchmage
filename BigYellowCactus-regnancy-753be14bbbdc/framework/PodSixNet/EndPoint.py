...
\t"""
    ...
    def ConnectionError(self):
        self.isConnected = False
        self.queue.append({"action": "error", "error": (-1,
                          "Connection error")})
...
if __name__ == "__main__":
    ...
    class FailEndPointTestCase(unittest.TestCase):
        ...
        def runTest(self):
            ...
            self.assertEqual(list(self.endpoint_bad.result), list(want),
                             "Socket got %s instead of %s" % (str(self.endpoint_bad.result),
                             str(want)))
            print
    ...
    class EndPointTestCase(unittest.TestCase):
        ...
        def setUp(self):
            self.outgoing = [{"action": "hello", "data": {"a": 321, "b": [2,
                             3, 4], "c": ["afw", "wafF", "aa", "weEEW",
                             "w234r"], "d": ["x"] * 256}}, {"action": "hello",
                             "data": [454, 35, 43, 543, "aabv"]}, {"action": "hello",
                             "data": [10] * 512}, {"action": "hello",
                             "data": [10] * 512, "otherstuff": "hello\0---\0goodbye",
                             "x": [0, "---", 0], "y": "zäö"}]
        ...
        def runTest(self):
            ...
            for x in range(50):
                ...
                for r in self.endpoint.received:
                    self.failUnless(r["data"] ==
                                    "Yeah, we got it: %d elements" %
                                    self.lengths.pop(0))
            ...
            self.assertTrue(self.endpoint.connected,
